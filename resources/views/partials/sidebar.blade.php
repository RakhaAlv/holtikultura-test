<aside
    ...
    <div class="relative z-10 flex h-full flex-col">
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('bawang-putih') }}" class="mb-4 flex items-center gap-4 rounded-lg px-2 py-2 transition
                {{ request()->routeIs('bawang-putih') ?  'bg-[#16B33A]' : 'hover:bg-[#0E5A22]' }}">
            ...
            <a href="{{ route('bawang-putih') }}" class="flex h-12 w-12 items-center justify-center rounded-xl hover:bg-green-700 transition
                {{ request()->routeIs('bawang-putih') ?  'bg-[#16B33A]' : 'hover:bg-[#0E5A22]' }}">
                <img src="{{ asset('Icon-Bawang.svg') }}" class="w-6">
            </a>

            <a href="{{ route('bawang-merah') }}" class="flex h-12 w-12 items-center justify-center rounded-xl hover:bg-green-700 transition
                {{ request()->routeIs('bawang-merah') ?  'bg-[#16B33A]' : 'hover:bg-[#0E5A22]' }}">
                <img src="{{ asset('Icon-Bawang.svg') }}" class="w-6">
            </a>

            <a href="{{ route('cabai') }}" class="flex h-12 w-12 items-center justify-center rounded-xl hover:bg-green-700 transition
                {{ request()->routeIs('cabai') ?  'bg-[#16B33A]' : 'hover:bg-[#0E5A22]' }}">
                <img src="{{ asset('Icon-Cabai.svg') }}" class="w-6">
            </a>

            <a href="{{ route('durian') }}" class="flex h-12 w-12 items-center justify-center rounded-xl hover:bg-green-700 transition
                {{ request()->routeIs('durian') ?  'bg-[#16B33A]' : 'hover:bg-[#0E5A22]' }}">
                <img src="{{ asset('Buah-Icon.svg') }}" class="w-6">
            </a>

            <a href="{{ route('p2b') }}" class="flex h-12 w-12 items-center justify-center rounded-xl hover:bg-green-700 transition
                {{ request()->routeIs('p2b') ?  'bg-[#16B33A]' : 'hover:bg-[#0E5A22]' }}">
                <img src="{{ asset('Icon-tractor.svg') }}" class="w-6">
            </a>
